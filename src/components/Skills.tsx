...
export default function Skills() {
  ...
  const designSkills = ['Figma', 'Photoshop', 'Illustrator', 'Premiere Pro'];
  const designs = [
  ...
  const videos = [
    {
      title: 'DJI Waypoint Flight',
      image: 'images/wpt_flight.jpg',
      url: 'https://youtu.be/F3OTJYvYf9k',
    },
    { title: 'DJI Mini 4 Pro', image: 'images/dji.jpg', url: 'https://youtu.be/fayRW1m8b7c' },
    {
      title: 'Mission Planner',
      image: 'images/mission_planner.jpg',
      url: 'https://youtu.be/SA_h5dvUuN8',
    },
  ];
  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto px-6 text-center">
        ...
        <p className="mb-8 mt-10 text-lg text-white/70">
          In my free time, I volunteer with VATSIM Scandinavia as part of the staff, where I
          contribute to designing event banners, posters, and various visual elements. I also have
          experience creating custom icons, color profiles, and vector graphics.
        </p>
        ...
        <p className="mb-8 text-lg text-white/70">
          ...
          and English, including versions with subtitles.
        </p>
          ...
          {videos.map((project, idx) => (
            <a href={project.url} target="_blank" rel="noopener noreferrer">
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ delay: idx * 0.1 }}
                className="rounded-[50px] corner-squircle overflow-hidden shadow-lg bg-white/5 backdrop-blur-md border border-white/10 hover:scale-102 hover:bg-slate-900 transition"
              >
                <img src={project.image} alt={project.title} className="w-full h-48 object-cover" />
                <div className="p-6 flex flex-col gap-4">
